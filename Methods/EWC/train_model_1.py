...
class data():
    ...
    def choose_data(self, i):
        ...
        if i==0:
            ...
            self.X_train_old = np.concatenate(self.X_train_0, self.X_train_1)
        elif i==3:
            self.X_train = self.X_train_3
            self.Y_train = self.Y_train_3
            self.X_train_old = np.concatenate(self.X_train_0, self.X_train_1, self.X_train_2)
...
if __name__ == '__main__' :
    ...
    Result_Path = f"/home/de532237/cancer/Bachelorarbeit/WP2/Methods/ewc/" + Model_Name + '/'
