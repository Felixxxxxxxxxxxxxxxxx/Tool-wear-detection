...
class data():
    ...
    def feature_extraction(self,i):

        self.choose_data(i)

        self.Pretrained_Weight_Path = f"/rwthfs/rz/cluster/home/de532237/cancer/Bachelorarbeit/WP2/Methods/feature_extraction/Model_{i-1}/checkpoint/model.ckpt"
        ...
        Result_Path = r"/home/de532237/cancer/Bachelorarbeit/WP2/Methods/feature_extraction/" + Model_Name + '/'
        ...
        if i!=0:
            model = unet_vanilla_fe(input_size=(image_width, image_height, 1), base=2, uncertainty=False, trainable=True)
...
if __name__ == '__main__' :
    ...
    for i in range (1,4):
        p = Process(target = dataset.feature_extraction, args = (i,))
        p.start()
        p.join() 
        time.sleep(1) 
