...
if __name__ == '__main__' :
    ...
    Result_Path = f"/home/de532237/cancer/Bachelorarbeit/WP2/Methods/lwf/" + Model_Name + '/'
    ...
    # Create the student
    student = unet_vanilla(input_size=(image_width, image_height, 1), base=2, uncertainty=False, trainable=True)
    ...
    Pretrained_Weight_Path = f"/home/de532237/cancer/Bachelorarbeit/WP2/Methods/lwf/Model_{I-1}/model_weights/"
